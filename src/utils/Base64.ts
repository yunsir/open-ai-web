...
const _fromUint8Array = _hasBuffer
    ? (u8a: any) => Buffer.from(u8a).toString('base64')
    : (u8a: any) => {
...
const extendString = function () {
    ...
    _add('fromBase64', function (this:any) { return decode(this) });
    _add('toBase64', function (this:any, urlsafe:any) { return encode(this, urlsafe) });
    _add('toBase64URI', function (this:any) { return encode(this, true) });
    _add('toBase64URL', function (this:any) { return encode(this, true) });
    _add('toUint8Array', function (this:any) { return toUint8Array(this) });
};
/**
...
const extendUint8Array = function () {
    ...
    _add('toBase64', function (this:any, urlsafe:any) { return fromUint8Array(this, urlsafe) });
    _add('toBase64URI', function (this:any) { return fromUint8Array(this, true) });
    _add('toBase64URL', function (this:any) { return fromUint8Array(this, true) });
};
/**
